...
public class OrangActivity extends Activity {
	EditText jawabanTxt;

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_orang);
    ...
    public void cekJawaban(View v){
		String jawabanBenar = "ORANG POLOS";
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.orang, menu);
		return true;
	}
